  ...
  const pillars = [
    {
      ...
      description: "We revitalize the local economy by modernising traditional practices and building new skill sets.",
      items: [
    ...
    },
    {
      ...
      description: "We foster collective action and transparent governance to ensure long-term stability.",
      items: [
    ...
    },
    {
      ...
      description: "We protect the Western Ghats' biodiversity while empowering the community economically.",
      items: [
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        ...
        >
          <h2 className="font-display text-4xl md:text-5xl text-forest mb-6">
            Building Resilient Rural Systems: ASTHA’s Holistic Model
          </h2>
          <p className="font-body text-lg text-forest-light max-w-3xl mx-auto">
            To enhance the rural ecosystem in the Velhe block, ASTHA implements an integrated strategy that transforms local resources into pathways for economic, social, and environmental resilience.
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          {pillars.map((pillar, index) => (
            ...
            >
              ...
              <h3 className="font-display text-2xl text-forest mb-2">{pillar.title}</h3>
              <p className="font-body font-semibold text-golden mb-4">{pillar.subtitle}</p>
              <p className="font-body text-forest-light mb-6 flex-grow">{pillar.description}</p>
              
              <ul className="space-y-3 mt-auto">
                {pillar.items.map((item, i) => (
                  <li key={i} className="flex items-start gap-3 text-sm font-body text-forest-light">
