...
const visionItems = [
  {
    icon: MapPin,
    title: '18 Gaon Maval',
    description: 'Creating a development prototype in the 18-village cluster of Velhe Taluka. A model that can be replicated across rural India.',
  },
  {
    icon: Users,
    title: 'Stop Distress Migration',
    description: 'Creating local economic viability so people can live in their villages with satisfaction, not flee to cities out of desperation.',
  },
  {
    icon: Leaf,
    title: 'Conserve the Western Ghats',
    description: 'Protecting one of the world\'s most biodiverse regions while creating sustainable livelihoods for communities that call it home.',
  },
];

const VisionSection = () => {
  return (
    <section id="vision" className="section-padding bg-cream relative overflow-hidden">
      {/* Background Pattern */}
        ...
        <ScrollReveal>
          <div className="max-w-4xl mx-auto text-center mb-20">
            ...
            <p className="font-body text-lg text-muted-foreground leading-relaxed">
              A cluster of villages needs to be developed, not just one. We want to create a model 
              of area development that proves sustainable transformation is possible — and replicable.
            </p>
          </div>
        </ScrollReveal>
        ...
        <ScrollReveal className="mt-24">
          <div className="bg-forest-dark rounded-2xl p-8 lg:p-16 text-center">
            <blockquote className="font-display text-2xl md:text-3xl lg:text-4xl text-cream italic mb-8 leading-relaxed">
              "We want to hand this work over to capable people, not keep it in our control. 
